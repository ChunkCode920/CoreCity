...
if (isset($_GET['id'])) {
    ...
    $appointment = $controller->userViewAppointment($appointment_id);
    ...
    if($controller->cancelAppointment($appointment_id)) {
        ...
        header("Location: users_appointments_list.php");
        exit();
    } else {
    ...
    <div class="container my-5">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <?php if ($appointment): ?>
                    <p><strong>Name:</strong> <?php echo htmlspecialchars($appointment['staff_name']); ?></p>
            ...
            <div class="card-footer text-end">
                ...
                <a href="users_appointments_list.php" class="btn btn-secondary">Back to Appointments</a>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="cancelAppointment.php" style="display: inline;">
