...
$staff_id = $_SESSION['user_id']; // Get the user ID from the session

// Fetch the user's current data directly from the database
require_once 'conn.php';  // Include the database connection
$stmt = $pdo->prepare("SELECT fullname, username, email, pfp FROM staff WHERE staff_id = :staff_id");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['delete_account'])) {
        ...
        if ($controller->deleteStaff($staff_id)) {
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="staff_dashboard.php" class="btn btn-dark w-100 mb-2">Home</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="staff_profile.php" style="display: inline;">
